Assembly program that will ask the user to enter 5 numbers from keyboard (each number is 1 digit between 0 and 9). Then it will find the average of these numbers.
